...
public interface UserDao extends JpaRepository<User, Long> {
	...
	// 아이디 찾기
    @Query("SELECT new kr.co.sist.etmarket.dto.UserDto(u.userLoginId, u.userPassword, u.userId, u.userName) FROM User u WHERE u.userEmail = :userEmail AND u.userPhone = :userPhone")
